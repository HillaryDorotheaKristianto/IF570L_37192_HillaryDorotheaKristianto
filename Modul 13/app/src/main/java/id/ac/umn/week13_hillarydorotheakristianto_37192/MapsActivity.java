package id.ac.umn.week13_hillarydorotheakristianto_37192;
...
import id.ac.umn.week13_hillarydorotheakristianto_37192.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daftarMarkerDanShape.add(new MarkerDanShape("Marker", "Universitas Multimedia Nusntara", 0.0, lokalTitiks));
        daftarMarkerDanShape.add(new MarkerDanShape("Circle", "Area 500m dari UMN", 500.0, lokalTitiks));
        lokalTitiks.clear();
    ...
    protected void gambarMarkerDanShape(){
        for(int i=0; i<daftarMarkerDanShape.size(); i++){
            ...
            if(ms.getJenis().equalsIgnoreCase("Marker")){
                ...
                ms.getObjekPeta(mMap.addPolyline(pl));
